...
public class PetProvider extends ContentProvider {
    ...
    static {
        ...
        sUriMatcher.addURI(com.example.android.pets.data.PetContract.CONTENT_AUTHORITY, com.example.android.pets.data.PetContract.PATH_PETS, PETS);
        sUriMatcher.addURI(com.example.android.pets.data.PetContract.CONTENT_AUTHORITY, com.example.android.pets.data.PetContract.PATH_PETS + "/#", PET_ID);
    ...
    private com.example.pets.data.PetDbHelper mDbHelper;


    @Override
    public boolean onCreate() {

        mDbHelper = new com.example.pets.data.PetDbHelper(getContext());
        return true;
    }
